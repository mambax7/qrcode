...
<div id="help-template" class="outer">
    ...
    <p class="even">
        <img src="<{$xoops_url}>/modules/qrcode/assets/images/logo.png" align="baseline"><BR><strong>&nbsp;QRCode
        module</strong>
        QRCode is a module for XXX.
    </p>
    <h4 class="odd">INSTALL/UNINSTALL</h4>

    No special measures necessary, follow the standard installation process – extract the "QRCode" folder into the
    ../modules directory. Install the module through Admin -> System Module -> Modules.
    If you need detailed instructions on how to install a module, please see the <a
    ...
    used.<BR><BR>
    <i>If your QRCode reader does not understand all the actions taken, try switching to another reader. We suggest the
        Quickmark QRCode reader. Available for various platforms. Link to their website
        <a href="http://2lk.nl/5p" target="_blank">here</a>.</i><BR><BR>
    </p>
