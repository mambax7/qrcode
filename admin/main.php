...
require_once XOOPS_ROOT_PATH . '/modules/qrcode/qrcode.php';
xoops_cp_header();
if (isset($_POST['type'])) {
    switch ($_POST['type']) {
        ...
        case 'phone':
            if (!$_POST['qr_phone']) {
                ...
                echo '<table width="400"><tr><td width="800"><div style="margin:30px;padding:10px;border:1px solid #aaa;width:500px;"><div style="margin-bottom:5px;border-bottom:1px solid #aaa;"><h3>'
                     . _QRCODE_WIZARD_H
                     . '</h3><font size="-2">'
                     . _QRCODE_WIZARD_D
                     . '</font><br><br></div><div style="padding:10px;"><p>'
                     . _QRCODE_RESULT
                     . '</p>';
                echo $res;
...
if (isset($_GET['a'])) {
    switch ($_GET['a']) {
        ...
        case 'url':
            echo '<table width="400"><tr><td width="800"><div style="margin:30px;padding:10px;border:1px solid #aaa;width:700px;"><div style="margin-bottom:5px;border-bottom:1px solid #aaa;"><h3>'
                 . _QRCODE_WIZARD_H
                 . ' :: '
                 . _QRCODE_URL_H
                 . '</h3><font size="-2">'
                 . _QRCODE_WIZARD_D
                 . '</font><br><br></div><div style="padding:10px;">';
            echo '<table><tr><td width="150" align="left"><img src="../assets/images/create_url.png" border="0" title="' . _QRCODE_URL_D . '"></td><td>';
        ...
        case 'email':
            echo '<table width="400"><tr><td width="800"><div style="margin:30px;padding:10px;border:1px solid #aaa;width:700px;"><div style="margin-bottom:5px;border-bottom:1px solid #aaa;"><h3>'
                 ...
                 . _QRCODE_WIZARD_D
                 . '</font><br><br></div><div style="padding:10px;">';
            echo '<table><tr><td width="150" align="left"><img src="../assets/images/create_email.png" border="0" title="' . _QRCODE_EMAIL_D . '"></td><td>';
    ...
    ';
        ...
        case 'phone':
            echo '<table width="400"><tr><td width="800"><div style="margin:30px;padding:10px;border:1px solid #aaa;width:700px;"><div style="margin-bottom:5px;border-bottom:1px solid #aaa;"><h3>'
                 ...
                 . _QRCODE_WIZARD_D
                 . '</font><br><br></div><div style="padding:10px;">';
            echo '<table><tr><td width="150" align="left"><img src="../assets/images/create_phone.png" border="0" title="' . _QRCODE_PHONE_D . '"></td><td>';
        ...
        case 'sms':
            echo '<table width="400"><tr><td width="800"><div style="margin:30px;padding:10px;border:1px solid #aaa;width:700px;"><div style="margin-bottom:5px;border-bottom:1px solid #aaa;"><h3>'
                 ...
                 . _QRCODE_WIZARD_D
                 . '</font><br><br></div><div style="padding:10px;">';
            echo '<table><tr><td width="150" align="left"><img src="../assets/images/create_sms.png" border="0" title="' . _QRCODE_SMS_D . '"></td><td>';
    ...
    ';
        ...
        case 'txt':
            echo '<table width="400"><tr><td width="800"><div style="margin:30px;padding:10px;border:1px solid #aaa;width:700px;"><div style="margin-bottom:5px;border-bottom:1px solid #aaa;"><h3>'
                 ...
                 . _QRCODE_WIZARD_D
                 . '</font><br><br></div><div style="padding:10px;">';
            echo '<table><tr><td width="150" align="left"><img src="../assets/images/create_txt.png" border="0" title="' . _QRCODE_TXT_D . '"></td><td>';
        ...
        case 'geo':
            echo '<table width="400"><tr><td width="800"><div style="margin:30px;padding:10px;border:1px solid #aaa;width:700px;"><div style="margin-bottom:5px;border-bottom:1px solid #aaa;"><h3>'
                 ...
                 . _QRCODE_WIZARD_D
                 . '</font><br><br></div><div style="padding:10px;">';
            echo '<table><tr><td width="150" align="left"><img src="../assets/images/create_geo.png" border="0" title="' . _QRCODE_GEO_D . '"></td><td>';
    ...
    ';
        ...
        case 'bus':
            echo '<table width="400"><tr><td width="800"><div style="margin:30px;padding:10px;border:1px solid #aaa;width:700px;"><div style="margin-bottom:5px;border-bottom:1px solid #aaa;"><h3>'
                 ...
                 . _QRCODE_WIZARD_D
                 . '</font><br><br></div><div style="padding:10px;">';
            echo '<table><tr><td width="150" align="left"><img src="../assets/images/create_contact.png" border="0" title="' . _QRCODE_BUS_D . '"></td><td>';
    ...
    echo '<table><tr>';
    echo '<td align="center" style="border-right:0px solid #aaa;"><img src="../assets/images/logo.png"></td>';
    ...
    echo '<br><br><table><tr><td><a href="main.php?a=url"><img src="../assets/images/create_url.png" border="0" title="'
         . _QRCODE_URL_D
         . '"></a></td><td><a href="main.php?a=email"><img src="../assets/images/create_email.png" border="0" title="'
         . _QRCODE_EMAIL_D
         . '"></a></td><td><a href="main.php?a=phone"><img src="../assets/images/create_phone.png" border="0" title="'
         . _QRCODE_PHONE_D
         . '"></a></td><td><a href="main.php?a=sms"><img src="../assets/images/create_sms.png" border="0" title="'
         . _QRCODE_SMS_D
         . '"></a></td><td><a href="main.php?a=txt"><img src="../assets/images/create_txt.png" border="0" title="'
         . _QRCODE_TXT_D
         . '"></a></td><td><a href="main.php?a=geo"><img src="../assets/images/create_geo.png" border="0" title="'
         . _QRCODE_GEO_D
         . '"></a></td><td><a href="main.php?a=bus"><img src="../assets/images/create_contact.png" border="0" title="'
         . _QRCODE_BUS_D
         . '"></a></td></tr><tr>';
